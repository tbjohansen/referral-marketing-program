...
const AdminProfile = () => {
  ...
  return (
    <div className="w-[100%] flex flex-row justify-center px-4 py-8">
      <div className="w-[70%] flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-[#d5d5b3] ">
        ...
        <div className="space-y-4 text-center divide-y divide-gray-300">
          ...
          <div className="flex justify-center pt-2 space-x-4 align-center">
            <div
              onClick={handleOpen}
              className="h-10 w-[100%] bg-primaryColor border-[1px] border-goldishColor cursor-pointer rounded-xl flex flex-row gap-1 justify-center text-white"
            >
